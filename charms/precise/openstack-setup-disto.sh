...
juju deploy --to=0 --config ./openstack.yaml openstack-dashboard
...
juju deploy -u --config ./openstack.yaml --repository=. local:precise/swift-storage -n 3

juju deploy --config ./openstack.yaml ceph -n 3
