...
#juju deploy --config ./openstack.yaml swift-proxy
#juju deploy --config ./openstack.yaml swift-storage

juju deploy --config ./openstack.yaml ceph
juju deploy -u --config ./openstack.yaml --repository=. local:precise/nova-compute -n 3
juju deploy -u --config ./openstack.yaml --repository=. local:precise/quantum-gateway -n 2
